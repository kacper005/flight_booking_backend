...
public class UserController {
  ...
  /**
   * Deletes all users except Admin, from the application state,
   * excluding those with the ADMIN role.
   *
   * @return 200 OK on success, 400 Bad request on error
   */
  @DeleteMapping
  @Operation(
      ...
      description = "Delete all users from the application state, excluding those with the "
          + "ADMIN role")
