...
public class FeedbackController {
    ...
    public ResponseEntity<String> addFeedback(@RequestBody Feedback feedback) {
        ...
        try {
            ...
            response = new ResponseEntity<>("Failed to add feedback: " + e.getMessage(), HttpStatus.BAD_REQUEST);
        }
        return response;
    }
    ...
    public ResponseEntity<String> updateFeedback(@PathVariable Integer id, @RequestBody Feedback feedback) {
        ResponseEntity<String> response;
    ...
    public ResponseEntity<String> deleteAllFeedback() {
        ...
        try {
            ...
            response = new ResponseEntity<>("Failed to remove all feedback: " + e.getMessage(),
    ...
    @Operation(summary = "Get feedback by user ID", description = "Retrieve all feedback submitted by a specific user.")
